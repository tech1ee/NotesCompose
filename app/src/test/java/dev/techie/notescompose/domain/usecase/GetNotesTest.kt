...
class GetNotesTest {
    ...
    private lateinit var fakeNoteRepository: dev.techie.notescompose.data.FakeNoteRepository

    @Before
    fun setup() {
        fakeNoteRepository = dev.techie.notescompose.data.FakeNoteRepository()
